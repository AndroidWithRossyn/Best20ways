...
//        back=findViewById(R.id.back);
        ...
        AppManage.getInstance(BloggingActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
        AppManage.getInstance(BloggingActivity.this).loadInterstitialAd(this);
